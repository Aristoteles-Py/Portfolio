...
function WorkCard(){
    return (
        <div className="w-full mt-5 ">
            <strong className="max-[650px]:ml-3 text-2xl text-gold-100">
                Ultimos projetos
            </strong>
            <div className="w-full flex justify-center gap-20 mt-2 max-[650px]:gap-10 max-[650px]:flex-col max-[650px]:items-center">
                <CardProject 
                img={calculadora}
                title="Calculadora"
