    ...
    return(
        <div className="w-fll mt-5 max-[650px]:p-4">
            <div className="flex gap-7 justify-center  max-[650px]:h-[400px] max-[650px]:w-[400px]">
                ...
                <img className="h-[400px] w-[400px] rounded max-[650px]:absolute max-[650px]:w-[350px] max-[650px]:h-[350px]" 
                src={myPhoto} 
                alt=""
                />

                <div className="flex flex-col w-[400px] max-[650px]:relative max-[650px]:w-[350px] max-[650px]:h-[350px] max-[650px]:justify-end max-[650px]:text-right">
                    ...
                    <div className='min-[650px]:hidden w-[500px] h-[280px] bg-white bg-opacity-50 absolute origin-center -rotate-[21deg] z-0 -mb-28'>
                    </div>
                </div>
            </div>
